...
struct __GameServerInfo : public binary_function<__GameServerInfo, __GameServerInfo, bool>
{
	...
	void Init() { szName = ""; szIP = ""; iConcurrentUserCount = 0; freeLimit = 0; premiumLimit = 0; }
	...
	__GameServerInfo(const std::string szName2, const std::string szIP2, int iConcurrentUserCount2, int freeLimit2, int premiumLimit2)
	{
		szName = szName2;
		szIP = szIP2;
		iConcurrentUserCount = iConcurrentUserCount2;
		freeLimit = freeLimit2;
		premiumLimit = premiumLimit2;
	}
};
