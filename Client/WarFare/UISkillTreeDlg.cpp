...
void CUISkillTreeDlg::PointPushUpButton(int iValue)
{
	...
	{
		if (*CGameBase::s_pPlayer->m_InfoBase.eNation == NationEnum::KARUS)
		{
		...
		else if (*CGameBase::s_pPlayer->m_InfoBase.eNation == NationEnum::ELMORAD)
		{
			switch (CGameBase::s_pPlayer->m_InfoBase.eClass)
			{
...
#define IN_RECT(a, b)	 ((a.left < b.x) && (a.right > b.x) && (a.top < b.y) && (a.bottom > b.y))
	...
	if (*CGameBase::s_pPlayer->m_InfoBase.eNation == NationEnum::ELMORAD)
	{
	...
	else if (*CGameBase::s_pPlayer->m_InfoBase.eNation == NationEnum::KARUS)
	{
