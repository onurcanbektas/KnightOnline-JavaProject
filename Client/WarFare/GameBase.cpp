...
bool CGameBase::GetTextByNation(NationEnum & eNation, std::string& szText)
{
	...
	{
		szText = "El Morad";/*::_LoadStringFromResource(IDS_NATION_ELMORAD, szText);(3011)*/
	}

	else if (eNation == NationEnum::KARUS)
	{
		szText = "Karus"; /*::_LoadStringFromResource(IDS_NATION_KARUS, szText);(3012)*/
	}

	else
	{
		szText = "Unknown Nation!!!"; /*::_LoadStringFromResource(IDS_NATION_UNKNOWN, szText);*/
		return false;
	}
