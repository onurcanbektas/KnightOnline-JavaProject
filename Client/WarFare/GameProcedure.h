...
public:
	...
	virtual bool	MsgRecv_VersionCheck(DataPack* pDataPack, int& iOffset); // 암호화 키도 같이 받는다..
	virtual bool	MsgRecv_GameServerLogIn(DataPack* pDataPack, int& iOffset); // virtual - 국가번호를 리턴한다.
