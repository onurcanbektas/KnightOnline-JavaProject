...
enum eKeyMap {	KM_HOTKEY1 = SDL_SCANCODE_1, 
				...
				KM_TOGGLE_HELP = SDL_SCANCODE_F1, 
				...
				KM_TARGET_PARTY1 = SDL_SCANCODE_F1, 
				KM_TARGET_PARTY2 = SDL_SCANCODE_F2, 
				KM_TARGET_PARTY3 = SDL_SCANCODE_F3, 
				KM_TARGET_PARTY4 = SDL_SCANCODE_F4, 
				KM_TARGET_PARTY5 = SDL_SCANCODE_F5, 
				KM_TARGET_PARTY6 = SDL_SCANCODE_F6, 
				KM_TARGET_PARTY7 = SDL_SCANCODE_F7, 
				KM_TARGET_PARTY8 = SDL_SCANCODE_F8 };
