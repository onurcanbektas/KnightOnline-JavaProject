...
{
	public static final short CHARACTER_CREATE_SUCCESS = 1;
	public static final short NO_MORE_CHARACTER = 2;
	public static final short INVALID_CHARACTER_POSITION = 3;
	public static final short INVALID_CHARACTER_NAME = 4;
	public static final short INVALID_RACE = 5;
	public static final short INVALID_SPECIALITY = 6;
